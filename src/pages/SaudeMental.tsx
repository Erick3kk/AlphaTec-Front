      ...
      <section className="relative bg-gradient-to-br from-emerald-700 to-teal-600 text-white py-24 overflow-hidden">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl md:text-2xl max-w-4xl mx-auto opacity-95 leading-relaxed mb-12">
            Cuide da mente com o mesmo carinho que cuida do corpo. Você merece paz.
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-6 py-20">
          ...
          <div className="grid md:grid-cols-2 gap-10 max-w-4xl mx-auto text-lg text-gray-700 leading-relaxed">
            <div className="flex items-start gap-5">
              <span className="text-4xl font-bold text-emerald-600 mt-1">❤️</span>
              <p><strong>Mais equilíbrio emocional</strong> – Menos ansiedade e estresse.</p>
            </div>
            <div className="flex items-start gap-5">
              <span className="text-4xl font-bold text-emerald-600 mt-1">❤️</span>
              <p><strong>Melhores relacionamentos</strong> – Comunicação e empatia fortalecidas.</p>
            </div>
            <div className="flex items-start gap-5">
              <span className="text-4xl font-bold text-emerald-600 mt-1">❤️</span>
              <p><strong>Produtividade e foco</strong> – Mente clara rende mais.</p>
            </div>
            <div className="flex items-start gap-5">
              <span className="text-4xl font-bold text-emerald-600 mt-1">❤️</span>
              <p><strong>Autoestima elevada</strong> – Se amar é o primeiro passo.</p>
            </div>
          </div>
